...
p <- ggplot(
  ...
  geom_hline(yintercept = threshold_log, color = "red") +
...
Asso_Sign = Asso[Asso$MinusLogPval > threshold_log,]
Pos_sign = initial_Pos[Asso$MinusLogPval > threshold_log]
Chr_sign = Asso$Num_chr[Asso$MinusLogPval > threshold_log]
MLP_sign = Asso$MinusLogPval[Asso$MinusLogPval > threshold_log]
